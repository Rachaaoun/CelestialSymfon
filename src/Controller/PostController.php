...
class PostController extends AbstractController
{
     ...
     */
    public function getList(PostRepository $repo,SerializerInterface $serializer):Response{
     
        $posts=$repo->findAll();
        $json=$serializer->serialize($posts,'json', ['groups' => ['post']]);


        return $this->json(['post'=>$posts],Response::HTTP_OK,[],[
    ...
    public function new(Request $request, EntityManagerInterface $entityManager,ValidatorInterface $validator,\Swift_Mailer $mailer): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $message = (new \Swift_Message('you got mail  +++')) 
                        ...
                        ->setTo($this->getUser()->getMailUtilisateur())
